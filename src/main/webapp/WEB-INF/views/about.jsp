               ...
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     ...
                     <div class="col-md-5 col-sm-5 col-xs-12">
                        <img class="img-responsive" src="${contextPath}/resources/images/img-07.jpg" alt="#" />
                     </div>
                  </div>
               </div>
            </div>
         </div>
         <div class="dark-section" style="background:url(${contextPath}/resources/images/walle.jpg)">
            <div class="container">
               <div class="row">
                  <div class="col-md-12 col-sm-12">
