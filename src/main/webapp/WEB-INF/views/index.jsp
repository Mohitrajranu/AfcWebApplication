...
<!-- //For-Mobile-Apps -->
  ...
  <script src="http://vjs.zencdn.net/4.12/video.js"></script>
   <%-- <link href="${contextPath}/resources/css/video-js.css" rel="stylesheet">
                        ...
                        <div class="right_top_section">
                           ...
                           <ul class="login">
                             <li class="login-modal">
                                 <a href="${contextPath}/login" class="login"><i class="fa fa-user"></i>Login</a>
                              </li>
                              <li>
                                 <div class="cart-option">
                                    <a href="${contextPath}/registration" ><i class="fa fa-shopping-cart"></i>Register</a>
                                 </div>
                              </li>
                           </ul>
                           <!-- end button section -->
                                 ...
                                 <nav class="navbar navbar-inverse">
                                    ...
                                    <div class="collapse navbar-collapse js-navbar-collapse">
                                       <ul class="nav navbar-nav">
                                          ...
                                          <li><a href="${contextPath}/team">Team</a></li>
                                                      ...
                                                      <div id="menCollection" class="carousel slide" data-ride="carousel">
                                                         <div class="carousel-inner">
                                                            <div class="item active">
                                                               <div class="banner-for-match"><a href="#"><img class="img-responsive" src="${contextPath}/resources/images/match-banner1.jpg" alt="#" /></a></div>
                                                            </div>
                                                            <!-- End Item -->
                                                            <div class="item">
                                                               <div class="banner-for-match"><a href="#"><img class="img-responsive" src="${contextPath}/resources/images/match-banner1.jpg" alt="#" /></a></div>
               ...
               <div class="carousel-inner" role="listbox">
                     ...
                     <div class="carousel-caption">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                           <div class="slider-contant" data-animation="animated fadeInRight">
                              <h3><br><br><br><br>If you Don't Practice<br>You <span class="color-yellow">Don'۪t Derserve</span><br>to win!</h3>
                  ...
                  <div class="item skyblue" data-ride="carousel" data-interval="5000">
                     <div class="carousel-caption">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                           <div class="slider-contant" data-animation="animated fadeInRight">
                              <h3><br><br><br>If you Don't Practice<br>You <span class="color-yellow">Don't Derserve</span><br>to win!</h3>
                  ...
                  <div class="matchs-vs">
                     <div class="vs-team">
                        <div class="team-btw-match">
                           <ul>
                              <li>
                                 <img src="${contextPath}/resources/images/img-03.png" alt="">
                                 <span>Footbal Team</span>
                              </li>
                              <li class="vs"><span>vs</span></li>
                              <li>
                                 <img src="${contextPath}/resources/images/img-04.png" alt="">
            ...
            <div class="row">
               <div class="col-lg-4 col-sm-4 col-xs-12">
                  <aside id="sidebar" class="left-bar">
                     ...
                     <%-- <spring:url value="resources/images" var="images1" />
                      <img class="img-responsive" src="${images1}/IMG_20190316_200319.jpg" alt="#" />
	                  --%>
	                  <video id="MY_VIDEO_1" class="video-js vjs-default-skin" controls
                      preload="auto" width="380" height="204" poster=""
                      data-setup="{}">
                      <spring:url value="resources/videos" var="videos1" />
                      <source src="${videos1}/media.io_AFC_Teaser.mp4" type='video/mp4'>
                       <%-- <source src="${videos1}/AFCTeaser.webm" type='video/webm'> --%>
                     <!--  <p class="vjs-no-js">To view this video please enable JavaScript, and consider upgrading to a web browser that <a href="http://videojs.com/html5-video-support/" target="_blank">supports HTML5 video</a></p> -->
                       </video>
	                   <%-- <video width="320" height="240" autoplay>
	                   <spring:url value="resources/videos" var="videos1" />
                       <source src="${videos1}/AFC_Teaser.mp4" type="video/mp4">
                       </video> --%>
                       <%--  <img class="img-responsive" src="${contextPath}/resources/images/IMG_20190316_200319.jpg" alt="#" /> --%>
                 ...
                 <!--  <aside id="sidebar" class="left-bar"> 
                     <div class="feature-matchs">
                        <div class="team-btw-match">
                           <%-- <ul>
                              <li>
                                 <img src="${contextPath}/resources/images/img-01_002.png" alt="">
                                 <span>Portugal</span>
                              </li>
                              <li class="vs"><span>vs</span></li>
                              <li>
                                 <img src="${contextPath}/resources/images/img-02.png" alt="">
                                 <span>Germany</span>
                              </li>
                           </ul>
                           <ul>
                              <li>
                                 <img src="${contextPath}/resources/images/img-03_002.png" alt="">
                                 <span>Portugal</span>
                              </li>
                              <li class="vs"><span>vs</span></li>
                              <li>
                                 <img src="${contextPath}/resources/images/img-04_003.png" alt="">
                                 <span>Germany</span>
                              </li>
                           </ul>
                           <ul>
                              <li>
                                 <img src="${contextPath}/resources/images/img-05_002.png" alt="">
                                 <span>Portugal</span>
                              </li>
                              <li class="vs"><span>vs</span></li>
                              <li>
                                 <img src="${contextPath}/resources/images/img-06.png" alt="">
                                 <span>Germany</span>
                              </li>
                           </ul>
                           <ul>
                              <li>
                                 <img src="${contextPath}/resources/images/img-07_002.png" alt="">
                                 <span>Portugal</span>
                              </li>
                              <li class="vs"><span>vs</span></li>
                              <li>
                                 <img src="${contextPath}/resources/images/img-08.png" alt="">
                                 <span>Germany</span>
                              </li>
                           </ul>
                           <ul>
                 ...
                 <%--  <h4>Points Table</h4>
                     ...
                     <div class="feature-matchs">
                        <table class="table table-bordered table-hover">
                           ...
                           <tbody>
                              <tr>
                                 <td>1</td>
                                 <td><img src="${contextPath}/resources/images/img-01_004.png" alt="">Liverpool</td>
                                 <td>10</td>
                                 <td>12</td>
                                 <td>20</td>
                              </tr>
                              <tr>
                                 <td>2</td>
                                 <td><img src="${contextPath}/resources/images/img-02_002.png" alt="">Chelsea</td>
                                 <td>10</td>
                                 <td>12</td>
                                 <td>20</td>
                              </tr>
                              <tr>
                                 <td>3</td>
                                 <td><img src="${contextPath}/resources/images/img-03_003.png" alt="">Norwich City</td>
                                 <td>20</td>
                                 <td>15</td>
                                 <td>20</td>
                              </tr>
                              <tr>
                                 <td>4</td>
                                 <td><img src="${contextPath}/resources/images/img-04_002.png" alt="">West Brom</td>
                                 <td>60</td>
                                 <td>10</td>
                                 <td>60</td>
                              </tr>
                              <tr>
                                 <td>5</td>
                                 <td><img src="${contextPath}/resources/images/img-05.png" alt="">sunderland</td>
                                 <td>30</td>
                                 <td>06</td>
                                 <td>30</td>
                              </tr>
                  ...
                  --%>
                   <div class="content-widget top-story" style="background: url(${contextPath}/resources/images/top-story-bg.jpg);">
               ...
               <div class="col-lg-8 col-sm-8 col-xs-12">
                <%--   <div class="news-post-holder">
                     <div class="news-post-widget">
                        <img class="img-responsive" src="${contextPath}/resources/images/img-01_002.jpg" alt="">
                        <div class="news-post-detail">
                           <span class="date" id="todayDate"></span>
                           <h2><a href="${contextPath}/blog">At vero eos et accusamus et iusto odio dignissimos ducimus</a></h2>
                           <p>Just hours after that his grandma had died, Angel Di Maria imagined how she might react if he didn't play</p>
                        </div>
                     </div>
                     <div class="news-post-widget">
                        <img class="img-responsive" src="${contextPath}/resources/images/img-02_003.jpg" alt="">
                        <div class="news-post-detail">
                           <span class="date" id="todayDate"></span>
                           <h2><a href="${contextPath}/blog">At vero eos et accusamus et iusto odio dignissimos ducimus</a></h2>
                           <p>Just hours after that his grandma had died, Angel Di Maria imagined how she might react if he didn't play</p>
                 ...
                 --%>
                   <div class="news-post-holder">
                     <div class="news-post-widget" id="afcimages">
                     <c:forEach items="${files}" var="file">
                     <div class="image-sliderfade fade" > 
   	                 <spring:url value="resources/images/afcImages" var="images" />
                      <img  src="${images}/${file}" alt="#" style=" vertical-align: middle; width:100%"/>
	                 </div> 
	                 </c:forEach>
                    <!--   <spring:url value="/resources/images" var="images" />
                      <img src="${images}/back.png"/>-->
                       <!--   <img class="img-responsive" src="${contextPath}/resources/images/img-03_003.jpg" alt="">-->
                       </div>
                       <br>
     ...
     <section class="video_section_main theme-padding middle-bg vedio">
         <!-- <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="full" > -->
                  <div class="videoslideshow-container">

                 <!-- Full-width images with number and caption text -->
                  <c:forEach items="${videos}" var="afcvd">
                  <div class="myvideoSlides">
                  <spring:url value="resources/videos/AfcVideos" var="afcvideos" />
                  <video style="width:100%"  loop muted autoplay  preload="metadata" controls src="${afcvideos}/${afcvd}" type='video/mp4' preload="metadata"> </video>
                  </div>
                  </c:forEach>
    <!-- <div class="myvideoSlides fade">
           <video style="width:100%"  loop muted autoplay  preload="metadata" controls src="VID_20190324_172842532.mp4" type='video/mp4' preload="metadata"> </video>
           </div>
           <div class="myvideoSlides fade">
           <video style="width:100%"  loop muted autoplay  preload="metadata" controls src="VID_20190324_172919042.mp4" type='video/mp4' preload="metadata"> </video>
            </div> -->
            <!-- Next and previous buttons -->
             <a class="prevvideo" onclick="plusSlides(-1)">&#10094;</a>
             <a class="nextvideo" onclick="plusSlides(1)">&#10095;</a>
              </div>
              <!--  </div>
               </div>
            </div>
               ...
               <div class="col-md-4">
                  <div class="full">
                     <div class="footer-widget">
                        ...
                        <p>Most of our events have hard and easy route choices as we are always keen to encourage new recruits.</p>
				...
				$(document)
						.ready(
								function() {
									...
									var now = new Date();
									var curr = dayNames[now.getDay()] + ", "
											+ monthNames[now.getMonth()] + " "
											+ now.getDate() + ", "
											+ now.getFullYear();
									document.getElementById('todayDate').innerHTML = curr;
									console.log(curr);
								});
			</script>
			<script type="text/javascript">
