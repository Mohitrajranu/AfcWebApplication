         ...
         <div class="row">
            <div class="container">
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="${contextPath}/resources/images/img-1-4.jpg" alt="John" style="width:100%">
                     <div class="">
                        <h4>John Doe</h4>
               ...
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="${contextPath}/resources/images/img-1-2.jpg" alt="Mike" style="width:100%">
                     <div class="">
                        <h4>Mike Ross</h4>
               ...
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="${contextPath}/resources/images/img-1-3.jpg" alt="John" style="width:100%">
                     <div class="">
                        <h4>John Doe</h4>
                        <p class="title">Designer</p>
                        <p>
